...
import { GhaAnalyzerWorkspace } from "@/features/gha-analyzer/components/GhaAnalyzerWorkspace";

export function GitHubActionsAnalyzer() {
  return (
    <div className="py-8 sm:py-10">
      <Container className="space-y-8 sm:space-y-10">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_19rem] lg:items-start">
            <div>
              ...
              <p className="text-muted-foreground mt-5 max-w-3xl text-lg leading-8">
                Paste workflow YAML to review permissions, dangerous triggers, unpinned
                actions, secret exposure on fork PRs, and artifact retention before merge.
              </p>
            ...
            <aside className="border-border bg-background rounded-lg border p-5">
              <p className="text-foreground text-sm font-semibold">Review-first checks</p>
              <dl className="mt-4 space-y-4 text-sm">
                ...
                <div className="border-border rounded-md border p-3">
                  ...
                  <dd className="text-foreground mt-1 font-medium">
                    Permissions, triggers, supply chain, secrets, artifacts
                  </dd>
                </div>
                <div className="border-border rounded-md border p-3">
        ...
        >
          <p className="text-foreground text-sm font-semibold">Privacy</p>
          <p className="text-muted-foreground mt-2 text-sm leading-6">
            Local processing: your workflow YAML is parsed in this browser tab. Nothing is
            uploaded to a server by this tool.
          </p>
        </section>

        <GhaAnalyzerWorkspace />
      </Container>
    </div>
  );
}
